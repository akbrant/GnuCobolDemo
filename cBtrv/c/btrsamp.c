...
#define FILE1_NAME "/usr/local/actianzen/data/samples/sample.btr"
#define FILE2_NAME "/usr/local/actianzen/data/samples/sample2.btr"
#else
#ifdef BTI_NLM
#define FILE1_NAME "sys:\\pvsw\\samples\\sample.btr"
#define FILE2_NAME "sys:\\pvsw\\samples\\sample2.btr"
#else
#define FILE1_NAME "c:\\ProgramData\\Actian\\PSQL\\samples\\sample.btr" 
#define FILE2_NAME "c:\\ProgramData\\Actian\\PSQL\\samples\\sample2.btr"
#endif
#endif
...
/* Don't pad our structures */
  ...
  #pragma option -a-
#else
  #if defined(_MSC_VER) || defined(__WATCOMC__) || defined(BTI_LINUX) || defined(BTI_LINUX_64) || defined(BTI_MACOSX) || defined(BTI_MACOSX_64)
    #pragma pack(1)
  #endif
#endif
